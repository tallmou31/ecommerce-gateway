...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("sn.esmt.mp2isi.ecommerce.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("sn.esmt.mp2isi.ecommerce.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
